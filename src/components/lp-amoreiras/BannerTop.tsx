...
export default function BannerTop() {
  ...
  const handleOpenWhatsApp = () => {
    openWhatsApp('Olá! Vi o banner no site da Unimais Amoreiras e gostaria de falar com um especialista.');
  };
          ...
          <div key={index} className="w-full h-full shrink-0 relative">
            ...
            <div className={`absolute bottom-2 md:bottom-4 lg:bottom-6 ${banner.btnPosition === 'right' ? 'right-4 md:right-8 lg:right-16' : 'left-4 md:left-8 lg:left-16'} z-20`}>
              <button
                ...
                className="bg-whatsapp-green hover:bg-[#128C7E] text-white font-bold py-1.5 px-4 md:py-2 md:px-6 rounded-lg shadow-xl transition-transform hover:scale-105 text-xs md:text-sm lg:text-base uppercase tracking-wide flex items-center justify-center gap-1.5 font-black"
              >
