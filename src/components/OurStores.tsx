...
export default function OurStores() {
  const stores = [
    ...
    {
      name: "Loja 3 – Campos Elíseos",
      address: "Rua D. Pachêco e Silva, 726\nJardim Novo Campos Eliseos – Campinas – SP",
    ...
    {
      name: "Loja 5 – Meta Veículos",
      address: "Av. das Amoreiras, 3401\nCampinas – SP",
      mapLink: "https://maps.app.goo.gl/",
      phone: "(19) 3217-8850",
      image: "https://lh3.googleusercontent.com/gps-cs-s/APNQkAHoycZnRk67egnR4TU9vQ_7GLUDDlgLj-Lwr31Dn9KiTUD5fTxyGTVCmL_mspkxlITq7Zvmnx18lcFUMfiN5LaEw0p8LY5a0WH_evkHvtJLnQqXdye0msRigMZQoNaVsGD8Ke31MpA1XxWS=s680-w680-h510"
    }
  ];
