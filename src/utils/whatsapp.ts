export const WHATSAPP_PHONE = '5519995142727'; // +55 19 99514-2727
  ...
  if (!message) {
    if (typeof window !== 'undefined') {
      ...
      if (pathname.startsWith('/veiculo/')) {
        ...
        message = 'Olá! Gostaria de fazer uma simulação de financiamento na Unimais Amoreiras.';
      } else if (pathname === '/venda-unimais' || pathname === '/vender') {
        message = 'Olá! Gostaria de saber mais sobre como vender meu veículo na Unimais Amoreiras.';
      } else if (pathname === '/encontrar-veiculo') {
        message = 'Olá! Gostaria de ajuda para encontrar um veículo específico no estoque.';
      } else {
        message = 'Olá! Vi o site da Unimais Amoreiras e gostaria de mais informações.';
      }
    } else {
      message = 'Olá! Vi o site da Unimais Amoreiras e gostaria de mais informações.';
    }
