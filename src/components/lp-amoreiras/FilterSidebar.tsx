          ...
          {openSections.specials && (
            <div className="mt-3 space-y-2">
              ...
              <select
                ...
                className="w-full bg-slate-50 border border-slate-200 rounded-lg px-2.5 py-1.5 text-xs text-slate-800"
              >
                <option value="">Todas as 6 Lojas</option>
                <option value="Loja Castelo">Loja Castelo - Campinas</option>
                <option value="Loja Amoreiras">Loja Amoreiras - Campinas</option>
                <option value="Loja Orosimbo Maia">Loja Orosimbo Maia - Campinas</option>
                <option value="Loja Taquaral">Loja Taquaral - Campinas</option>
                <option value="Hortolândia">Loja Hortolândia</option>
              </select>
            </div>
          )}
        </div>
